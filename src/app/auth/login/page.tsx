    ...
    <main className="min-h-dvh flex flex-col items-center justify-center px-6">
      ...
      <div className="w-full max-w-sm space-y-8 animate-fade-up relative">
        <div>
          ...
          <h1 className="font-serif text-4xl italic text-text-primary mt-6 mb-2">Welcome back</h1>
        </div>
        ...
        <p className="text-text-muted text-sm text-center">
          New here?{' '}
          <Link href="/auth/signup" className="text-amber-glow hover:text-amber-soft transition-colors">
            Start your circle
          </Link>
        </p>
      </div>
